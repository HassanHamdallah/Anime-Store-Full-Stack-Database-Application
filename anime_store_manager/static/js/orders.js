...
async function calculateStats() {
    ...
    try {
        ...
        if (response.ok) {
            ...
            // Calculate total spent from loaded orders
    ...
    return `
        <div class="order-card" onclick="openOrderModal(${order.orderId})">
            ...
            <div class="order-footer">
                ...
                <button class="btn-view-details" onclick="event.stopPropagation(); openOrderModal(${order.orderId})">
                    View Details
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
function updateTimeline(status, orderDate) {
    ...
    const timelineHTML = `
        ...
        <div class="timeline-item ${currentIndex >= 1 ? 'completed' : currentIndex === 0 ? 'active' : ''}">
            ...
            <div class="timeline-content">
                <h4>Processing</h4>
                <p>${currentIndex >= 1 ? 'Completed' : 'Pending'}</p>
            </div>
        </div>
        <div class="timeline-item ${currentIndex >= 2 ? 'completed' : currentIndex === 1 ? 'active' : ''}">
            ...
            <div class="timeline-content">
                <h4>Shipped</h4>
                <p>${currentIndex >= 2 ? 'In Transit' : 'Pending'}</p>
            </div>
        </div>
        <div class="timeline-item ${currentIndex >= 3 ? 'completed' : currentIndex === 2 ? 'active' : ''}">
            ...
            <div class="timeline-content">
                ...
                <p>${currentIndex >= 3 ? 'On the way' : 'Pending'}</p>
            </div>
        </div>
        <div class="timeline-item ${currentIndex >= 4 ? 'completed' : currentIndex === 3 ? 'active' : ''}">
            <div class="timeline-dot"></div>
            <div class="timeline-content">
                <h4>Delivered</h4>
                <p>${currentIndex >= 4 ? 'Completed' : 'Estimated delivery'}</p>
            </div>
        </div>
    `;
